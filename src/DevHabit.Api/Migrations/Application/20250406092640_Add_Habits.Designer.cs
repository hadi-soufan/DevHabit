...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250406092640_Add_Habits")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.Haibts.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.Haibts.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Api.Entities.Frequencies.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Api.Entities.Milestones.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Api.Entities.Targets.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
